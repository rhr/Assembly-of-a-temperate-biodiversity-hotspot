...
\subsubsection*{Ingroup: \textit{Acer}; outgroup scope: Sapindaceae}
...
\subsubsection*{Ingroups: Clematidinae+Anemoninae, Delphineae, and
  \textit{Thalictrum}; outgroup scope: Ranunculaceae}
...
\subsubsection*{Ingroup: \textit{Isodon}; outgroup scope: Lamiaceae}
...
\subsubsection*{Ingroup: \textit{Lilium}, including
  \textit{Nomocharis}; outgroup scope: Lilieae (Liliaceae)}
...
\subsubsection*{Ingroup: \textit{Meconopsis}; outgroup scope:
  Papaveraceae}
...
\subsubsection*{Ingroup: Microsoroideae; outgroup scope:
  Polypodiaceae}
...
\subsubsection*{Ingroup: Polygoneae; outgroup scope:
...
\subsubsection*{Ingroup: Primuloideae; outgroup scope: Primulaceae
  sensu lato}
...
\subsubsection*{Ingroups: \textit{Rhodiola} and
  Saxifragaceae+Grossulariaceae; outgroup scope: Saxifragales}
...
\subsubsection*{Ingroup: \textit{Rhododendron}; outgroup scope: Ericaceae}
...
\subsubsection*{Ingroup: \textit{Rosa}; outgroup scope: Rosales}
