...
\significancestatement{Why do so many species occur in mountains? A
  ...
  biodiversity hotspot where uplift began about 8 million years ago,
  this rate does in fact show a significant increase since that time,
  ...
  explain the prevalence of mountains in global biodiversity
  hotspots.}
...
\acknow{Y.X.\ was supported by the Boyd Postdoctoral Fellowship at the
  Field Museum and by the Swiss National Science Foundation
  (XXXXX?). The authors thank D.~Boufford for comments on a draft.}
