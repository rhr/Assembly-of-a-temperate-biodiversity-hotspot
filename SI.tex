...
to be monophyletic. Included in the list are fossil-calibrated
``backbone'' analyses that we ran to derive secondary calibrations for
some ingroups.

\subsubsection*{Clade 1. Ingroup: \textit{Allium}; outgroup scope:
  Amaryllidaceae}
...
\subsubsection*{Backbone: Asteraceae}

We ran this analysis to derive secondary calibrations for clade 2, the
