...
\item \textit{P3, column 2, para 2. Is it really precise enough to
  ...
  context. We have edited this section (XXX) to describe how
  topographic differences between the Hengduan Mountains and Himalayas
...
\item \textit{P4, column 1, lines 394-398. Yes, a strong role for
  ...
  (XXX). If the reviewer were willing to shed anonymity we would be
  happy to cite this particular point as a personal communication (in
  addition to a more general acknowledgement).
...
\item \textit{P4, column 1, lines 401-404. Related to the above, this
  ...
  elevation, and other abiotic and biotic factors are needed
  (XXX). However, we believe this to be beyond the scope of this
...
\item \textit{The diversification rate estimates and lack of any rate
  ...
  SXXX indicate that across most of the phylogeny, the rate is between
...
\item \textit{The authors treated the Qinghai-Tibetan Plateau (QTP)
  ...
  through time. The results, summarized in Figures SXXX, are virtually
  identical to the original results with respect to Hengduan assembly
  dynamics.
